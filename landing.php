        ...
        <div class="row">
            ...
            <div class="mt-3 welcome-login col-sm-4 align-self-end">
                ...
                <?php if (isset($_SESSION['email'])): ?>
                    <p class="welcome-info text-right">Welcome <br><strong><?php echo $_SESSION['email']; ?></strong><br><a href="landing.php?logout='1'" class="welcome-info logout-color">Logout</a></p>
                <?php endif ?>
...
<div class="content col-sm" style='background-color: rgb(217, 217, 217)'>
