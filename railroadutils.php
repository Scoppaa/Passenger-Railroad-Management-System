...
function doSearch()
{
    ...
    {         
        ...
        //Start Search
        echo "<div class='search-container'><div class ='search'><form id='insertForm' action='{$thisPHP}' method='post' style='width:100%;background-color:#d1d1d1;border-width:0px;'>";
        echo "<input type='text' name='txtSearchTerm' style='float:left;margin-bottom:10px;'><input type='submit' name='btnSearch' value='Search' style='float:left;margin-bottom:10px;margin-left:10px;'>";
        echo "</form></div></div>";
        //End Search
        
        //Start Clear Search
        echo "<div class='search-container'><div class ='search'><form class='form1' id='form' action='{$thisPHP}' method='post' style='width:100%;background-color:#d1d1d1;border-width:0px;'>";
    ...
    {         
        ...
        */
        ...
        while($row = $result->fetch_assoc()) 
        {
            ...
            echo "<form action='{$thisPHP}' method='post' style='display:inline;border-width:0px;background-color:aquamarine;'>";
            echo "<input type='hidden' name='TRIP_ID' value='{$TRIP_ID}'>";
            echo "<input type='submit' name='btnDelete' value='Delete' style='width:100%;'></form>";
            echo "</td></tr></tbody>";
...
<script>
    $(document).ready(function() {
        ...
        $('#tableMain tbody').on('click', 'tr', function() {
            ...
            window.location.href = "landing.php?w1=" + departurestation + "&w2=" + departuretime + "&w3=" + arrivalstation + "&w4=" + arrivaltime + "&w5=" + trackid + "&w6=" + trainid;
